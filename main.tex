 ...
 \section{State of Art}
   ...
   \begin{figure}[H]
    ...
    \includegraphics[width=0.5\textwidth]{Imagenes/microscope_garrido.jpg}
     \caption{Lanthanide orthophosphates in biomedical TEM imaging applications.\cite{garrido_hernandez_photoluminescence_2016}}
...
\chapter{Resultados y Discusión}
 ...
 \section{Zircón (\texorpdfstring{\ce{ZrSiO4}}{ZrSiO4})} 
   El zircón es un prototipo estructura y referencia de estabilidad .Los parámetros cristalográficos del Zircón \ce{ZrSiO4} se obtienen de ``Materials Data on \ce{ZrSiO4} by Materials Project''\footnote{\url{https://next-gen.materialsproject.org/materials/mp-4820}} \cite{zircon_data_2020}.
 ...
 \section{Xenótimo (\texorpdfstring{\ce{LnPO4}}{LnPO4}, Ln = Y, Tb-Lu)}
   Los fosfatos de tierras raras pesados (Tb-Lu, Y, Sc) cristalizan en la estructura del Xenótimo, isoesctructural con el Zircón \cite{chong_synthesis_2024}, con un menor radio iónico del catión metálico que permite una mejor compactación de la estructura. 
 ...
 \section{Churchita (\texorpdfstring{\ce{LnPO4*nH2O}}{LnPO4*nH2O}, Ln= Y, Tb-Lu)}
   La Churchita es un fosfato hidratado de tierras raras (Ln = Y, Tb-Lu) pesadas (menor radio iónico). Su estructura es laminar debido a la presencia de moléculas de agua en su red cristalina. Es la fase precursora de la xenotima, estable solo a bajas temperaturas (<200-300 °C). \cite{rafiuddin_review_2022,rafiuddin_structural_2022}.
...
\vspace{0.5cm}
 ...
 \section{Monacita (\texorpdfstring{\ce{LnPO4}}{LnPO4}, Ln = La-Gd)}
   La Monacita es un fosfato de tierras raras ligeras (La-Gd) que cristaliza en un sistema monoclínico, adoptando una estructura diferente a la del Xenótimo y el Zircón \cite{chong_synthesis_2024}, debido a su mayor tamaño iónico.
...
\vspace{0.5cm}
 ...
 \section{Rhabdofano (\texorpdfstring{\ce{LnPO4*nH2O}}{LnPO4*nH2O}, Ln= Y, Tb-Lu)}
    El Rhabdofano es un fosfato hidratado de tierras raras (Ln = Y, Tb-Lu) ligeras (mayor radio iónico).Se caracteriza por formar canales abiertos (zeolíticos) donde se alojan moléculas de agua estructural (0.5−0.8 moléculas por fórmula), lo que permite variabilidad en su hidratación \cite{enikeeva_structure_2023,rafiuddin_review_2022}. Al calentarse (500–900 °C), colapsa irreversiblemente a estructura monacita \cite{chong_synthesis_2024,shelyug_thermodynamics_2018}.
