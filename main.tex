...
% ==============================================================================
% AQUÍ ESTÁ LA CORRECCIÓN: Cargamos biblatex UNA SOLA VEZ con todas las opciones
\usepackage[
    backend=biber,
...
% 1. Quitar la "sangría francesa" típica de APA (margen izquierdo a 0)
\setlength{\bibhang}{0pt}

% 2. Añadir espacio entre cada referencia
\setlength{\bibitemsep}{1.5\baselineskip}

% --- INICIO DEL TRUCO DE MAGIA ---
% Esto es necesario para que biblatex-apa acepte pintar los números
\ExecuteBibliographyOptions{labelnumber}

% Definimos que el número lleve corchetes [1]
\DeclareFieldFormat{labelnumberwidth}{\mkbibbrackets{#1}}

% Redefinimos el entorno de la bibliografía para que pinte la lista numérica
