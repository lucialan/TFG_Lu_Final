...
\begin{minipage}[c]{0.75\textwidth} % Columna de TEXTO (Izquierda)
  ...
  El tetraedro \ce{SiO4} presenta cuatro enlaces equivalentes con varianza angular de \SI{97.71}{\degree\squared} y alargamiento cuadrático de 1.0238, indicando compresión axial. Volumen: \SI{2.13}{\cubic\angstrom}.
...
\begin{minipage}[c]{0.20\textwidth} % Columna de IMAGEN (Derecha)
  ...
  \begin{figure}[H]
    ...
    \caption{Tetraedro \ce{SiO4} del zircón (d = \SI{1.626}{\angstrom}, BLD = 0).}
    \label{fig:zircon_td}
  \end{figure}
\end{minipage}
...
\begin{minipage}[c]{0.25\textwidth}
  ...
  \begin{figure}[H]
    ...
    \captionsetup{justification=centering}
    \caption{Bisdisfenoide \ce{ZrO8} (Zr--O: \SI{2.13}{\angstrom}--\SI{2.27}{\angstrom}, BLD = 0.0318).}
...
\begin{minipage}[C]{0.3\textwidth} % Columna de TEXTO (Izquierda)
  ...
  \begin{figure}[H]
    ...
    \caption{Bisdisfenoide \ce{YO8} (Y--O: \SI{2.31}{\angstrom}--\SI{2.38}{\angstrom}, BLD = 0.0149).}
