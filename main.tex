...
\begin{minipage}[c]{0.75\textwidth} % Columna de TEXTO (Izquierda)
  ...
  Sin embargo, el poliedro no es un tetraedro geométrico ideal. El análisis de los ángulos de enlace revela una varianza angular de (\SI{97.71}{\degree})\(^2\) y un alargamiento cuadrático de 1.0238, valores que indican una compresión significativa del poliedro a lo largo del eje \(c\) (ver Figura \ref{fig:zircon_c_poly}). El volumen calculado para este poliedro es de \SI{2.13}{\cubic\angstrom}.
