...
\begin{minipage}[c]{0.75\textwidth} % Columna de TEXTO (Izquierda)
  ...
  donde \(n\) es el número de enlaces, \(d_i\) la distancia del enlace \(i\), y \(\bar{d}\) la distancia promedio. Un valor de BLD = 0 indica un poliedro geométricamente ideal, mientras que valores mayores reflejan mayor irregularidad en las distancias de enlace. En el caso del tetraedro \ce{SiO4} del zircón, el BLD = 0.0000 confirma la perfección de las distancias de enlace.
