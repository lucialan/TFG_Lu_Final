...
\chapter{Resultados y Discusión}
 ...
 \begin{wrapfigure}{r}{0.3\textwidth} % r=derecha, l=izquierda, 0.5=ancho
  \centering
  \includegraphics[width=0.25\textwidth]{Imagenes/1_ZIRCON/ZIRCON_Td.png}
 ...
 \begin{wrapfigure}{l}{0.3\textwidth} % r=derecha, l=izquierda, 0.5=ancho
  \centering
  \includegraphics[width=0.3\textwidth]{Imagenes/1_ZIRCON/ZIRCON_Dode.png}
  \caption{Dodecaedro \ce{ZrO8} del Zircón}
 \end{wrapfigure} 
...
Esta disparidad se refleja en un índice de distorsión de la longitud de enlace de 0.0318 (frente al valor nulo observado para el Si). La distancia media de enlace Zr--O resultante es de \SI{2.205}{\angstrom}, y el poliedro ocupa un volumen considerablemente mayor, de \SI{19.18}{\cubic\angstrom}, consistente con el mayor radio iónico del zirconio (ver Figuras \ref{fig:Zircón_big_a} y \ref{fig:Zircón_big_c}).
 ...
 \begin{wrapfigure}{r}{0.25\textwidth} % r=derecha, l=izquierda, 0.5=ancho
  \centering
  \includegraphics[width=0.25\textwidth]{Imagenes/2_XENOTIMO/XENOTIMO_Td.png}
 ...
 \begin{wrapfigure}{l}{0.25\textwidth} % r=derecha, l=izquierda, 0.5=ancho
  \centering
  \includegraphics[width=0.25\textwidth]{Imagenes/2_XENOTIMO/XENOTIMO_Dode.png}
